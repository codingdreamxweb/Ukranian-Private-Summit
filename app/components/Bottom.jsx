    ...
    <section style={{maxWidth: '85%', margin: '0 auto', backgroundColor: '#0B4C99', borderRadius: 20}}>
      <div className="container bottom">
        <div className="bottom__first-line">
          ...
          <p className="date">March 21, 2024<br/> at Google Campus Warsaw, Poland</p>
          <div className="link">
            <a className="link-site" href="">
            Visit UVCA summit organiser website
            <Image className="arrow" src={arrow} alt="arrow"></Image>
            </a>
            <p className="link-text">If you are interested in promoting your company / organization<br/> at the Summit, please contact us - <a className="link-mail" href="">p.relations@uvca.eu</a></p>
          </div>
        </div>
